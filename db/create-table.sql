...
BEGIN
    CREATE TABLE Incidents (
        ...
        supportingDocName NVARCHAR(255),
        supportingDocMime NVARCHAR(150),
        supportingDocData VARBINARY(MAX),
        adminSupportingDocName NVARCHAR(255),
        adminSupportingDocMime NVARCHAR(150),
        adminSupportingDocData VARBINARY(MAX),
        createdByEmail NVARCHAR(255),
        createdByName NVARCHAR(255),
        approvalStatus NVARCHAR(20) NOT NULL DEFAULT 'Pending',
        verifiedByEmail NVARCHAR(255),
        verifiedByName NVARCHAR(255),
